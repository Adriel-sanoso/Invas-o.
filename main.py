...
def menu():
    ...
    while run:
        ...
        title_label = title_font.render("Invasion", 1, (200, 0, 0))

        start_label = title_font.render("(S)tart", 1, (0, 255, 0))
        instruction_label = title_font.render("(I)nstrução", 1, (200, 0, 200))
        ...
        if keys[pygame.K_i]:
            win.blit(bg, (0, 0))
            title_label1 = title_font.render("Use as setas para mover", 1, (255, 255, 255))
            title_label2 = title_font.render("e espaço para atirar", 1, (255, 255, 255))
            ...
            title_label6 = title_font.render("BY ADRIEL-SANO", 1, (66, 135, 245))
